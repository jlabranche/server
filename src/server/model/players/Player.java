...
public abstract class Player {
	...
	public boolean initialized = false, disconnected = false,
			...
			addStarter = false, accountFlagged = false, maxed = false, msbSpec = false;
	...
	saveDelay, playerKilled, pkPoints, totalPlayerDamageDealt, killedBy,
			...
			dialogueAction = 0, EquipStatus, autocastId, followDistance, followId2,
			barrageCount = 0, delayedDamage = 0, delayedDamage2 = 0,
			pcPoints = 0, magePoints = 0, repPoints = 0, slayPoints = 0, rankLevel = 0, presLevel = 0, desertTreasure = 0,
 ...
 public int getLocalY() {
	...
	public final int[] BOWS = { 9185, 839, 845, 847, 851, 855, 859, 841, 843,
			849, 853, 857, 861, 4212, 4214, 4215, 9705, 11235, 4216, 4217, 4218,
			4219, 4220, 4221, 4222, 4223, 6724, 4734, 4934, 4935, 4936, 4937 };
	public final int[] ARROWS = { 9706, 882, 884, 886, 888, 890, 892, 4740, 11212,
	...
	public final int[] CROSSBOWS = { 9174, 9176, 9177, 9179, 9181, 9183, 9185 };
	...
	public int rangeEndGFX, boltDamage, teleotherType, playerTradeWealth,
			doAmount, stageT, dfsCount, recoilHits,
	...
	public int[] fishingProp = new int[3];
	public boolean miningP = false,
			secondHerb = false;
	public boolean playerIsSpinning;
	...
	public boolean inMulti() {
		if ((absX >= 3136 && absX <= 3327 && absY >= 3519 && absY <= 3607)
				...
				|| (absX >= 2538 && absX <= 2615 && absY >= 3070 && absY <= 3102)
