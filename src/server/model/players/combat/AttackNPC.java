...
public class AttackNPC {
	...
	public static void applyNpcMeleeDamage(Client c, int i, int damageMask, int damage) {
		...
		if(c.fightMode == 3) {
			if(c.presLevel == 1) {
			c.getPA().addSkillXP((damage*Config.P1MELEE_EXP_RATE/3), 0); 
			c.getPA().addSkillXP((damage*Config.P1MELEE_EXP_RATE/3), 1);
			c.getPA().addSkillXP((damage*Config.P1MELEE_EXP_RATE/3), 2); 				
			c.getPA().addSkillXP((damage*Config.P1MELEE_EXP_RATE/3), 3);
