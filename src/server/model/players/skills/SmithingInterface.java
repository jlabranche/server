...
private void craftingInterface(Client c){
		
		c.getPA().sendFrame126("", 1112);
		c.getPA().sendFrame126(GetForlvl2(34, c)+"LvL 34"+GetForlvl2(34, c), 1109);
		c.getPA().sendFrame126(GetForlvl2(50, c)+"LvL 50"+GetForlvl2(50, c), 1110);
		c.getPA().sendFrame126(GetForlvl2(29, c)+"LvL 29"+GetForlvl2(29, c), 1118);
		c.getPA().sendFrame126(GetForlvl2(40, c)+"LvL 40"+GetForlvl2(40, c), 1111);
		c.getPA().sendFrame126("", 1095);
		c.getPA().sendFrame126("", 1115);
		c.getPA().sendFrame126("", 1090);
		c.getPA().sendFrame126(GetForlvl2(70, c)+"LvL 70"+GetForlvl2(70, c), 1113);
		c.getPA().sendFrame126(GetForlvl2(22, c)+"LvL 22"+GetForlvl2(22, c), 1116);
		c.getPA().sendFrame126(GetForlvl2(56, c)+"LvL 56"+GetForlvl2(56, c), 1114);
		c.getPA().sendFrame126("", 1089);
		c.getPA().sendFrame126(GetForlvl2(67, c)+"LvL 67"+GetForlvl2(67, c), 8428);
		c.getPA().sendFrame126(GetForlvl2(24, c)+"LvL 24"+GetForlvl2(24, c), 1124);
		c.getPA().sendFrame126(GetForlvl2(20, c)+"LvL 20"+GetForlvl2(20, c), 1125);//
		c.getPA().sendFrame126(GetForlvl2(27, c)+"LvL 27"+GetForlvl2(27, c), 1126);
		c.getPA().sendFrame126(GetForlvl2(43, c)+"LvL 43"+GetForlvl2(43, c), 1127);
		c.getPA().sendFrame126(GetForlvl2(55, c)+"LvL 55"+GetForlvl2(55, c), 1128);
		c.getPA().sendFrame126(GetForlvl2(31, c)+"LvL 31"+GetForlvl2(31, c), 1129);
		c.getPA().sendFrame126(GetForlvl2(80, c)+"LvL 80"+GetForlvl2(80, c), 1130);
		c.getPA().sendFrame126(GetForlvl2(71, c)+"LvL 72"+GetForlvl2(72, c), 1131);
		c.getPA().sendFrame126(GetForlvl2(90, c)+"LvL 90"+GetForlvl2(90, c), 13357);
		c.getPA().sendFrame126("", 11459);
		c.getPA().sendFrame126("", 1101);
		c.getPA().sendFrame126(GetForlvl3(50, c)+"Ruby Amulet"+GetForlvl3(50, c), 1099);
		c.getPA().sendFrame126(GetForlvl3(40, c)+"Ruby Neck"+GetForlvl3(40, c), 1100);
		c.getPA().sendFrame126("", 1088);
		c.getPA().sendFrame126("", 1105);
		c.getPA().sendFrame126(GetForlvl3(34, c)+"Ruby Ring"+GetForlvl3(34, c), 1098);
		c.getPA().sendFrame126("", 1092);
		c.getPA().sendFrame126(GetForlvl3(29, c)+"Emerald Neck"+GetForlvl3(29, c), 1083);
		c.getPA().sendFrame126(GetForlvl3(56, c)+"Diamond Neck"+GetForlvl3(56, c), 1104);
		c.getPA().sendFrame126(GetForlvl3(70, c)+"Diamond Amulet"+GetForlvl3(70, c), 1103);
		c.getPA().sendFrame126(GetForlvl3(72, c)+"Dragon Neck"+GetForlvl3(72, c), 1106);
		c.getPA().sendFrame126("", 1086);
		c.getPA().sendFrame126(GetForlvl3(22, c)+"Sapphire Neck"+GetForlvl3(22, c), 1087);
		c.getPA().sendFrame126(GetForlvl3(80, c)+"Dragon Amulet"+GetForlvl3(80, c), 1108);
		c.getPA().sendFrame126(GetForlvl3(24, c)+"Sapphire Amulet"+GetForlvl3(24, c), 1085);
		c.getPA().sendFrame126("", 9144);
		c.getPA().sendFrame126(GetForlvl3(90, c)+"Onyx Amulet"+GetForlvl3(90, c), 13358);
		c.getPA().sendFrame126(GetForlvl3(43, c)+"Diamond Ring"+GetForlvl3(43, c), 1102);
		c.getPA().sendFrame126(GetForlvl3(31, c)+"Emerald Amulet"+GetForlvl3(31, c), 1093);
		c.getPA().sendFrame126(GetForlvl3(20, c)+"Sapphire Ring"+GetForlvl3(20, c), 1094);
		c.getPA().sendFrame126(GetForlvl3(27, c)+"Emerald Ring"+GetForlvl3(27, c), 1091);
		c.getPA().sendFrame126("",1135);
		c.getPA().sendFrame126("",1134);
		c.getPA().sendFrame126(GetForlvl3(67, c)+"Onyx Ring"+GetForlvl3(67, c), 8429);
		c.getPA().sendFrame126(GetForlvl2(55, c)+"Dragon Ring"+GetForlvl2(55, c),1107);
		 c.getPA().sendFrame126(GetForlvl3(82, c)+"Onyx Neck"+GetForlvl3(82, c),11461);
		 c.getPA().sendFrame126(GetForlvl2(82, c)+"LvL 82"+GetForlvl2(82, c),11459);
		 c.getPA().sendFrame126("",1132);
		 c.getPA().sendFrame126("",1096);
		 ...
		 //rings
		 c.getPA().sendFrame34(1637,0,1119,1); 
		 c.getPA().sendFrame34(1639,0,1120,1); 
		 c.getPA().sendFrame34(1641,0,1121,1); 
		 c.getPA().sendFrame34(1643,0,1122,1); 
		 c.getPA().sendFrame34(1645,0,1123,1); 
		 //rings
		 
		 //ammys
		 c.getPA().sendFrame34(1675,1,1119,1); 
		 c.getPA().sendFrame34(1677,1,1120,1); 
		 c.getPA().sendFrame34(1679,1,1121,1); 
		 c.getPA().sendFrame34(1681,1,1122,1); 
		 c.getPA().sendFrame34(1683,1,1123,1); 
		 //ammys
		 
		 
		 
		 // necks
		 c.getPA().sendFrame34(1656,2,1119,1); 
		 c.getPA().sendFrame34(1658,2,1120,1); 
		 c.getPA().sendFrame34(1660,2,1121,1); 
		 c.getPA().sendFrame34(1662,2,1122,1); 
		 c.getPA().sendFrame34(1664,2,1123,1); 
		 //necks
		 
		 // misc
		 c.getPA().sendFrame34(-1,3,1119,1); 
		 c.getPA().sendFrame34(-1,3,1120,1); 
		 c.getPA().sendFrame34(-1,3,1121,1); 
		 c.getPA().sendFrame34(-1,3,1122,1); 
		 c.getPA().sendFrame34(-1,4,1119,1); 
		 c.getPA().sendFrame34(6575,4,1120,1); 
		 c.getPA().sendFrame34(6577,4,1121,1); 
		 c.getPA().sendFrame34(6579,4,1122,1);
		 c.getPA().sendFrame34(-1,4,1123,1); 		 
		 //misc
		 c.getPA().showInterface(994);	
	}

	private String GetForlvl2(int i, Client c) {
		if (c.playerLevel[c.playerCrafting] >= i)
		return "@gre@";
	
		return "@red@";
		}
	private String GetForlvl3(int i, Client c) {
		if (c.playerLevel[c.playerCrafting] >= i)
		return "@whi@";
